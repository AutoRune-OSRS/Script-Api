package io.autorune.script.api.vars

import io.autorune.script.api.client

enum class VarBits(val varBitId: Int)
{
	...
	BANK_WITHDRAW_NOTE(3958),
	BANK_INSERT_ITEM(3959),
	BANK_INCINERATOR_ACTIVE(5102),
	BANK_DEPOSIT_WORN_ITEMS_ACTIVE(5364),
	BANK_DEPOSIT_INVENTORY_ACTIVE(8352),

	PLACE_HOLDERS_ENABLED(3755),
	...
	companion object
	{
		...
		suspend fun fetchVarBit(varBit: VarBits) : Int
		{
			return client().fetchVarBitValue(varBit.varBitId)
		}
	}
